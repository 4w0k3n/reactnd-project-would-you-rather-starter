        ...
        return (
            <div>
                <Container fluid={true}>
                    <Row>
                        <Badge bg='secondary' style={{fontSize: 38}}> Create a new Question: Complete the sentence</Badge>
                    </Row>
                </Container>
                <Container>
                    <Row style={{marginTop: '5rem'}}>
                        ...
                        <div style={{marginTop:'2rem'}}>
                            <Button variant='outline-primary' style={{margin: '2rem'}} onClick={e => this.handleCreateQuestion(e)}>Create</Button>
